...
enum class StatusMessageKey {
    ...
    HOME_SSH_PRIVATE_KEY_IMPORTED,
    HOME_SSH_PRIVATE_KEY_IMPORT_FAILED,
    HOME_SSH_SETTINGS_INVALID,
    HOME_SSH_ROUTE_SAVED,
    HOME_SSH_ROUTE_SAVED_RESTART_REQUIRED,
    HOME_SSH_ROUTE_RESTARTING,
    ...
    FAILED_TO_REFRESH,
    SUBSCRIPTION_REFRESH_TLS_FAILED,
    SUBSCRIPTION_REFRESH_CONNECTIVITY_FAILED,
    SUBSCRIPTION_REFRESH_PARSE_FAILED,
    SUBSCRIPTION_REFRESH_PREPARATION_FAILED,
    SUBSCRIPTION_REFRESH_PERSISTENCE_FAILED,
    SUBSCRIPTION_REFRESH_OTHER_FAILED,
    ...
    ROUTING_RULES_OUTCOME_UNKNOWN,
    ROUTING_RULES_STALE_DRAFT,
}
