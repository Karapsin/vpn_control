...
enum class UiText {
    ...
    SELECTED_PROFILE,
    SELECTED_LOCATION,
    ACTIVE_CONNECTION_LOCATION,
    ACTIVE_CONNECTION_UNKNOWN,
    CONNECTION_RESTART_PENDING,
    CONNECTION_RESTART_UNKNOWN,
    SERVER,
    MISMATCH_TITLE,
    ...
    SETTINGS_CUSTOM_DNS,
    SETTINGS_HOME_SSH_ROUTE,
    HOME_SSH_DESCRIPTION,
    HOME_SSH_ENABLED,
    HOME_SSH_HOST,
    HOME_SSH_PORT,
    HOME_SSH_USER,
    HOME_SSH_HOST_KEYS,
    HOME_SSH_HOST_KEYS_HELP,
    HOME_SSH_RELAY_PORT,
    HOME_SSH_PRIVATE_KEY,
    HOME_SSH_KEY_IMPORTED,
    HOME_SSH_KEY_MISSING,
    IMPORT_PRIVATE_KEY,
    HOME_SSH_RESTART_TITLE,
    HOME_SSH_RESTART_DESCRIPTION,
    RESTART_NOW,
    RESTART_LATER,
    HOME_SSH_PENDING,
    ...
    UPDATE_UP_TO_DATE,
    UPDATE_INSTALLING,
    UPDATE_INSTALL_CONFIRMATION,
    UPDATE_INSTALL_COMPLETED,
    UPDATE_INSTALL_UNKNOWN,
    UPDATE_INSTALL_CANCELLED,
    UPDATE_INSTALL_INTERACTION_REQUIRED,
