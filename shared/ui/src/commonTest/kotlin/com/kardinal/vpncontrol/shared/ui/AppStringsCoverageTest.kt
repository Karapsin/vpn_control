...
class AppStringsCoverageTest {
    ...
    fun structuredStatusMessagesAreLocalized() {
        val structuredMessages = listOf(
            ...
            ConnectionStatusMessages.startingConnection(AppMode.PROXY_ONLY),
            ConnectionStatusMessages.startingConnectionWithBestLocation(AppMode.VPN),
            ConnectionStatusMessages.startingConnectionWithBestLocation(AppMode.PROXY_ONLY),
            ConnectionStatusMessages.connectionReadyOnComputer(AppMode.PROXY_ONLY),
            RuntimeStatusMessages.desktopAppInitialized(),
            RuntimeStatusMessages.runtimeMode(AppMode.VPN.name),
            RuntimeStatusMessages.runtimeLog("/tmp/sing-box:a|b.log"),
            RuntimeStatusMessages.preflightPassed(AppMode.VPN),
            RuntimeStatusMessages.desktopVpnCapabilityReady(),
            BenchmarkStatusMessages.noLocationsAvailableForBenchmarking(),
            BenchmarkStatusMessages.bestLocationSearchTimedOut(),
            BenchmarkStatusMessages.retryingBestLocationSearch(attempt = 2, total = 3),
            BenchmarkStatusMessages.locationSearchCancelled(),
            BenchmarkStatusMessages.locationSearchFailed(),
            BenchmarkStatusMessages.locationSearchCancelledStopFailed(AppMode.VPN, "stop failed"),
            BenchmarkStatusMessages.vpnPermissionRequired(),
            BenchmarkStatusMessages.noSuitableLocationFound(),
            BenchmarkStatusMessages.bestLocationNotMapped(),
            SubscriptionStatusMessages.noSubscriptionsSaved(),
            ...
            SubscriptionStatusMessages.subscriptionRefreshStart(targetCount = 1, auto = true),
            SubscriptionStatusMessages.subscriptionRefreshStart(targetCount = 2, auto = true),
            ...
            SubscriptionStatusMessages.subscriptionsRefreshedCount(refreshedCount = 1, totalCount = 2),
            SubscriptionStatusMessages.subscriptionsRefreshedPartial(
                refreshedCount = 1,
                totalCount = 2,
                failedLabel = "Example",
            ),
            SubscriptionStatusMessages.locationsRefreshed(1),
            SubscriptionStatusMessages.locationsRefreshed(2),
            SubscriptionStatusMessages.failedToRefresh("Example"),
            SubscriptionStatusMessages.failedToRefreshActiveSubscription(),
            SubscriptionStatusMessages.failedToRefreshSubscriptions(),
            SubscriptionStatusMessages.noSubscriptionsRefreshed(),
            SubscriptionStatusMessages.noActiveSubscriptionSelected(),
            BenchmarkStatusMessages.loadingSavedLocations(),
            BenchmarkStatusMessages.downloadingRemoteSource(),
            BenchmarkStatusMessages.resolvingRemoteSource("Example"),
            BenchmarkStatusMessages.subscriptionSourceLoadFailed("Example"),
            BenchmarkStatusMessages.noLocationsFoundSelectedSubscription(),
            BenchmarkStatusMessages.noLocationsFoundInSource("Example"),
            BenchmarkStatusMessages.checkingTcpSpeed("Germany"),
            BenchmarkStatusMessages.checkingLocations(12),
            BenchmarkStatusMessages.checkingLocationSource(12, "ALL_SUBSCRIPTIONS"),
            ...
            SubscriptionStatusMessages.profileSourceMode(ProfileSourceMode.CURRENT_LOCATIONS),
            SubscriptionStatusMessages.subscriptionNameReset(),
            SubscriptionStatusMessages.subscriptionNameSaved(),
            SubscriptionStatusMessages.subscriptionDeleted(),
            ...
            LocationStatusMessages.invalidLocationConfig(),
            LocationStatusMessages.locationAlreadySaved("Germany"),
            LocationStatusMessages.locationEditUnavailable(),
            ...
            LocationStatusMessages.importLocationsFailed(),
            LocationStatusMessages.locationsImported(removedSelected = false),
            ...
            LocationStatusMessages.clipboardEmpty(),
            LocationStatusMessages.clipboardReadFailed(),
            SubscriptionStatusMessages.subscriptionTextLoadedIntoProfile(),
            SubscriptionStatusMessages.profileSourceSet(ProfileSourceMode.SUBSCRIPTION),
            SubscriptionStatusMessages.profileSourceSet(ProfileSourceMode.CURRENT_LOCATIONS),
            ConnectionStatusMessages.disconnectFirstChangeConnectionMode(),
            RoutingStatusMessages.connectionModeSet(AppMode.VPN),
            RoutingStatusMessages.connectionModeSet(AppMode.PROXY_ONLY),
            RoutingStatusMessages.ruleSetRemoved(),
            RoutingStatusMessages.switchToSavedLocationsToAddLocations(),
            RoutingStatusMessages.historyEntryDeleted(),
            ConnectionStatusMessages.selectedLocationUnchanged("Germany"),
            ConnectionStatusMessages.selectedLocationSet("Germany"),
            ConnectionStatusMessages.selectedLocationApplying(),
            ConnectionStatusMessages.updatedSelectedLocationApplying(),
            ConnectionStatusMessages.selectedLocationApplyFailed(),
            ConnectionStatusMessages.selectedLocationSelectFailed(),
            ConnectionStatusMessages.updatedSelectedLocationApplyFailed(),
            ConnectionStatusMessages.updatedSelectedLocationSaveFailed(),
            ConnectionStatusMessages.updatedSelectedLocationAppliedSaveFailed(),
            ConnectionStatusMessages.connectionStoppedKeepStateConsistent(AppMode.VPN),
            ConnectionStatusMessages.previousConnectionRestored(AppMode.VPN),
            ConnectionStatusMessages.previousConnectionRestoredWithReason(AppMode.VPN, "retry failed."),
            ConnectionStatusMessages.previousConnectionRestoreFailedStopped(AppMode.VPN, "restore failed"),
            ConnectionStatusMessages.previousConnectionRestoreOrStopFailed(
                AppMode.VPN,
                restoreFailure = "restore failed",
                stopFailure = "stop failed",
            ),
            LocationStatusMessages.locationChecked("Germany"),
            LocationStatusMessages.locationCheckFailed(),
            LocationStatusMessages.locationEdited(12),
            RoutingStatusMessages.sampleRuleSetAdded(),
            RoutingStatusMessages.ruleSetDeleted("desktop-1"),
            RoutingStatusMessages.routingRulesSaved(),
            RoutingStatusMessages.routingRulesSavedRestartRequired(AppMode.VPN),
            RoutingStatusMessages.routingRulesSaveFailed(),
            RoutingStatusMessages.routingRulesImported(),
            RoutingStatusMessages.routingRulesImportedRestartRequired(AppMode.VPN),
            RoutingStatusMessages.routingRulesImportedRestartRequired(AppMode.PROXY_ONLY),
            RoutingStatusMessages.routingRulesImportFailed(),
            RoutingStatusMessages.routingRulesCopiedToClipboard(),
            RoutingStatusMessages.routingRulesExportCanceled(),
            RoutingStatusMessages.routingRulesExportedTo("/tmp/rules.json"),
            RoutingStatusMessages.routingRulesExportFailed(),
            RoutingStatusMessages.routingRulesFileOpenFailed(),
            LocationStatusMessages.locationsCopiedToClipboard(),
            LocationStatusMessages.locationsExportCanceled(),
            LocationStatusMessages.locationsExportedTo("/tmp/locations.txt"),
            LocationStatusMessages.locationsExportFailed(),
            LocationStatusMessages.locationsFileOpenFailed(),
            LocationStatusMessages.locationsFileReadFailed(),
            DiagnosticsStatusMessages.diagnosticsExportCanceled(),
            DiagnosticsStatusMessages.diagnosticsExportedTo("/tmp/diagnostics.txt"),
            DiagnosticsStatusMessages.diagnosticsExportFailed(),
            DiagnosticsStatusMessages.diagnosticsDestinationOpenFailed(),
            DiagnosticsStatusMessages.diagnosticsExportOpened(),
            ...
            SettingsStatusMessages.startupSettingUpdateFailed(),
            SettingsStatusMessages.subscriptionHwidCleared(),
            SettingsStatusMessages.subscriptionHwidSaved(),
            SettingsStatusMessages.refreshSettingsSaveFailed(),
            SettingsStatusMessages.appModeChanged(AppMode.PROXY_ONLY),
            ...
            ConnectionStatusMessages.previousLocationUnavailable(),
            ConnectionStatusMessages.restoringPreviousConnection("Germany"),
            ConnectionStatusMessages.connectionStartedOnTarget(AppMode.VPN, "tun-test"),
            ConnectionStatusMessages.connectionStartedOnTarget(AppMode.PROXY_ONLY, "127.0.0.1:2080"),
            ...
            ConnectionStatusMessages.connectionStartCancelled(AppMode.VPN),
            ConnectionStatusMessages.connectionStopCancelled(AppMode.PROXY_ONLY),
            ...
            ConnectionStatusMessages.bestLocationStartedSaveFailed(AppMode.VPN),
            SubscriptionStatusMessages.backgroundRefreshFindingBest(),
            ConnectionStatusMessages.backgroundVpnPermissionRequiredKeepingPrevious(),
            ConnectionStatusMessages.appClosedConnectionWasOff(),
            ConnectionStatusMessages.connectionStoppedReconnectOnNextLaunch(AppMode.VPN),
            ConnectionStatusMessages.connectionStopBeforeExitFailed(AppMode.VPN),
            SubscriptionStatusMessages.subscriptionReceived(),
            SubscriptionStatusMessages.subscriptionLinkReceived(),
            SubscriptionStatusMessages.locationConfigReceived(),
            SubscriptionStatusMessages.sharedTextUnsupportedImport(),
            SubscriptionStatusMessages.pasteSubscriptionRequired(),
            SubscriptionStatusMessages.subscriptionSaved(),
            SubscriptionStatusMessages.invalidRemoteSource(),
            RoutingStatusMessages.invalidRuleSet(),
            RoutingStatusMessages.ruleSetAdded(),
            RoutingStatusMessages.ruleSetUpdated(),
            ...
            SubscriptionStatusMessages.backgroundRefreshReplacementFailed(
                AppMode.VPN,
            ...
            SubscriptionStatusMessages.backgroundRefreshSelectedMissingKept(AppMode.VPN, failedLabel = null),
            SubscriptionStatusMessages.backgroundRefreshSelectedMissingKept(AppMode.VPN, failedLabel = "Example failed"),
            SubscriptionStatusMessages.backgroundRefreshKeptCurrent(AppMode.VPN, failedLabel = null, selectedSourceFailed = false),
            SubscriptionStatusMessages.backgroundRefreshKeptCurrent(
                AppMode.VPN,
                failedLabel = "Example failed",
                selectedSourceFailed = true,
            ),
            SubscriptionStatusMessages.backgroundRefreshReplacementStopped(AppMode.VPN),
            SubscriptionStatusMessages.backgroundRefreshRestoreOrStopFailed(AppMode.VPN, "restore failed"),
            SubscriptionStatusMessages.backgroundRefreshFailed(),
            SubscriptionStatusMessages.replacementLocationSearchFailed(),
            SubscriptionStatusMessages.replacementLocationSaveFailed(),
        )
        ...
        val sharedStatusFallbacks = nonEnglishLanguages.flatMap { language ->
            ...
            listOf(
                SettingsStatusMessages.uiSettingVisibilityChanged(UiSettingsStatusItem.SESSION_STATS, true),
                SettingsStatusMessages.uiSettingVisibilityChanged(UiSettingsStatusItem.LIVE_TRAFFIC_STATS, false),
                LocationStatusMessages.subscriptionLocationSaveReadOnly(),
                LocationStatusMessages.locationAdded("Germany"),
                LocationStatusMessages.locationRemoved("Germany"),
                LocationStatusMessages.selectedLocationRemovedConnectionStopped(AppMode.VPN, "Germany"),
                LocationStatusMessages.importLocationsBlocked(),
                LocationStatusMessages.locationsImported(removedSelected = true),
                LocationStatusMessages.locationsImportedSelectedUnavailableConnectionStopped(AppMode.PROXY_ONLY),
            ).mapNotNull { message ->
                val localized = strings.statusMessage(message)
        ...
        assertTrue(
            AppStrings(AppLanguage.RUSSIAN)
                .statusMessage(SettingsStatusMessages.validationSettingsSaved(BenchmarkValidationSettings(batchSize = 4, retryCount = 2)))
                .contains("группа 4"),
        )
        assertTrue(
            AppStrings(AppLanguage.GERMAN)
                .statusMessage(SettingsStatusMessages.subscriptionAutoRefreshSet(SubscriptionRefreshPolicy.CUSTOM, 0.5))
    ...
    fun easterEggLanguagesUseThemedVocabulary() {
        ...
        val oldRussianText = easterEggVocabularySample(oldRussian) + "\n" + listOf(
            oldRussian.statusMessage(GeneralStatusMessages.languageSet("Древнерусский")),
            oldRussian.statusMessage(RuntimeStatusMessages.runtimeMode(AppMode.VPN.name)),
            oldRussian.statusMessage(RuntimeStatusMessages.runtimeMode(AppMode.PROXY_ONLY.name)),
            oldRussian.statusMessage(RuntimeStatusMessages.preflightPassed(AppMode.VPN)),
        ...
        val sovietText = easterEggVocabularySample(soviet) + "\n" + listOf(
            soviet.statusMessage(GeneralStatusMessages.languageSet("Советский")),
            soviet.statusMessage(RuntimeStatusMessages.runtimeMode(AppMode.VPN.name)),
            soviet.statusMessage(RuntimeStatusMessages.runtimeMode(AppMode.PROXY_ONLY.name)),
            soviet.statusMessage(RuntimeStatusMessages.preflightPassed(AppMode.VPN)),
