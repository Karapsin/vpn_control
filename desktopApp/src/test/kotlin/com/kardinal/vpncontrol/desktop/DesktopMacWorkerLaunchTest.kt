...
class DesktopMacWorkerLaunchTest {
    ...
    private val worker = desktopMacTestPath("/Users/東京/' dollar$ (not a command)/vpn-control-install-worker")
    ...
    @Test fun launchRequiresExactWorkerLeafCanonicalJobAndBoundedNativePid() {
        ...
        assertFails { DesktopMacWorkerLaunch.watcher(desktopMacTestPath("/tmp/../vpn-control-install-worker"), job, 123) }
    }
}
