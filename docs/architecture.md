...
| Main state/actions | `app/src/main/java/com/kardinal/vpncontrol/MainViewModel.kt`, focused `Android*ActionsService` classes, `AndroidControllerEffectHandler.kt` plus shared controller | `desktopApp/src/main/kotlin/com/kardinal/vpncontrol/desktop/DesktopAppService.kt` plus focused desktop services including `DesktopSettingsService.kt` | `shared/core/src/commonMain/kotlin/com/kardinal/vpncontrol/MainController.kt`, `MainUiState.kt`, `MainUiStateProjector` |
...
| Runtime lifecycle | `app/src/main/java/com/kardinal/vpncontrol/vpn/AndroidVpnService.kt` | `DesktopConnectionActionsService.kt`, `DesktopConnectionLifecycleService.kt`, `desktopApp/src/main/kotlin/com/kardinal/vpncontrol/desktop/DesktopProxyRuntimeManager.kt` | shared state models |
...
| Android VPN or app assignment routing | `MainViewModel`, `AndroidRoutingActionsService`, Android storage/runtime classes, `SingBoxConfigFactory`, Android instrumentation tests, Android smoke docs. |
