...
| Main state/actions | `app/src/main/java/com/kardinal/vpncontrol/MainViewModel.kt` plus shared controller | `desktopApp/src/main/kotlin/com/kardinal/vpncontrol/desktop/DesktopAppService.kt` plus focused desktop services | `shared/core/src/commonMain/kotlin/com/kardinal/vpncontrol/MainController.kt`, `MainUiState.kt`, `MainUiStateProjector` |
...
| Subscription source activation, add/delete, rename, or source labels | `SubscriptionSourceLogic`, desktop subscription management service, Android subscription actions, shared core tests. |
...
| Selected location matching, remapping, or stored-key normalization | `SelectionMappingLogic`, Android selected-state call sites, desktop location/subscription services, shared core tests. |
