...
| Main state/actions | `app/src/main/java/com/kardinal/vpncontrol/MainViewModel.kt`, focused `Android*ActionsService` classes, `AndroidControllerEffectHandler.kt` plus shared controller | `desktopApp/src/main/kotlin/com/kardinal/vpncontrol/desktop/DesktopAppService.kt` plus focused desktop services | `shared/core/src/commonMain/kotlin/com/kardinal/vpncontrol/MainController.kt`, `MainUiState.kt`, `MainUiStateProjector` |
