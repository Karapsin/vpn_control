...
| Profile parsing | Android uses the shared parser from app workflows | Desktop uses the shared parser from service workflows | `shared/core/src/commonMain/kotlin/com/kardinal/vpncontrol/data/VlessParser.kt` (`ProxyParser`) |
...
| --- | --- |
| Subscription payload or direct-link parsing | `ProxyParser`/`VlessParser`, parser tests, import/export behavior, `docs/sing-box-contract.md`, Android and desktop smoke docs. |
