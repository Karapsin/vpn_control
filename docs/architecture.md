...
| User-visible status or log text | `shared/model/src/commonMain/kotlin/com/kardinal/vpncontrol/model/StatusMessageTypes.kt`, `StatusMessageCodec.kt`, `StatusMessageKeySelectors.kt`, `StatusMessages.kt`, `shared/ui/src/commonMain/kotlin/com/kardinal/vpncontrol/shared/ui/StatusMessageRenderer.kt`, `shared/ui/src/commonMain/resources/i18n-status/*.json`, status renderer/coverage tests, `scripts/status_catalog_tool.py`, `docs/localization.md`. |
