...
- Home SSH Route settings, fail-closed behavior, and VPN-aware subscription downloads should stay aligned. The home relay installer supports Linux `amd64` and `arm64`; the client feature uses the bundled runtime on every packaged platform.
