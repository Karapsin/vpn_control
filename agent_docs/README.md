...
| SSH Routing and home relay | `../docs/ssh-routing.md`, `state-ownership.md`, `sing-box-contract.md` | shared config builders, platform credential stores, subscription clients, `scripts/install_home_relay.sh` | Shared core tests plus Android and desktop tests |
