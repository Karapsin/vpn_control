...
case "$(uname -m)" in
  arm64) worker_arch=arm64; deployment_target=11.0 ;;
  x86_64) worker_arch=amd64; deployment_target=10.13 ;;
...
xcrun clang "-mmacosx-version-min=$deployment_target" -std=c11 -O2 -Wall -Wextra -Werror -Wno-deprecated-declarations \
